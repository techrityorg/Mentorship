> If you are following the TMP curriculum we recommend you to first take a look at the complete curriculum, which you can find [here](https://github.com/Techrityorg/curriculum).
