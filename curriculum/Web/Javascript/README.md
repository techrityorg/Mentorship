> If you are following the HackYourFuture curriculum we recommend you to start with module 1: [HTML/CSS/GIT](https://github.com/Techrityorg/HTML&CSS). To get a complete overview of the Techrity curriculum first, click [here](https://github.com/Techrityorg/curriculum).

> Please help us improve and share your feedback! If you find better tutorials
> or links, please share them by [opening a pull request](https://github.com/Techrityorg/JavaScript/pulls).
...
If you feel ready for the next challenge, click [here](https://www.github.com/Techrityorg/Browsers) to go to Browsers!
