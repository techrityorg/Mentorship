...
Nigeria's first mobile-only bank, [Kuda Bank](https://kuda.com/), was granted a license by the Central Bank of Nigeria (CBN) in 2019. Consequently, Kuda is only available online and has no physical locations. Babs Ogundeyi and Musty Mustapha formed Kuda Bank. This guide illustrates getting started with the Kuda bank app.

We'll go over creating a Kuda account and using the app's fundamental features. Download your app on the [Google Playstore](https://play.google.com/store/apps/details?id=com.kudabank.app&hl=en&gl=US) store for android devices and Let's get started.

# CREATE ACCOUNT

You have control over your finances, spending, and savings when you have a Kuda account. You may accomplish all of this with the assistance of Kuda, commonly known as the bank of the free, with almost no charges. Let's look at creating a Kuda account.
...
Secondly, Kuda uses Artificial intelligence to record your face.
...
_N/B: your transaction pin and your passcode are not the same thing. The former is for performing transactions while the latter is for accessing your kuda dashboard._
...
When the more about survey is completed, you can access your dashboard and start transacting.
...
Here's how to send money on with bank transfer
...
You can pay directly on from your Kuda account to online stores with Pay ID.
...
<iframe width="640" height="360" src="https://www.youtube.com/embed/dx95T5lFTtE" title="How To Pay With Kuda Online" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- Also, you can only copy your account number.
...
Kuda Flexible savings allows you save daily, weekly, or monthly toward a goal and get up to 10% annual interest. Use the steps listed below to create your flexible savings plan
...
Borrowing money on Kuda accomplished through with an overdraft. A Kuda overdraft is a short-term loan you can take anytime as long as you use your Kuda account frequently.
To be eligible for an overdraft you'd need:

- Upgrade your account with your BVN and a valid ID.
- Use your account frequently.

And Kuda automatically offers you and overdraft

Check out how to borrow money on Kuda below

<iframe width="699" height="393" src="https://www.youtube.com/embed/R10Y8QHde6Q" title="How To Borrow Money On Kuda" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1663974813718/5rIbFNVBv.png)
...
One of the perks of using the kuda card is the control you have. Say, for example, your physical card gets stolen you can easily [block your card](https://help.kuda.com/en/articles/3365550-block-your-kuda-card) on the app.
